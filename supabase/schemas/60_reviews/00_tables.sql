...
ALTER TABLE ONLY public.study_sessions
    ADD CONSTRAINT study_sessions_member_id_fkey FOREIGN KEY (member_id) REFERENCES public.members(id) ON DELETE CASCADE;
...
CREATE POLICY "Members can view their own study sessions" ON public.study_sessions FOR SELECT TO authenticated USING ((( SELECT public.active_member_id() AS active_member_id) = member_id));
