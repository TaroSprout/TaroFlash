...
Land in the middle: a short noun phrase or simple sentence naming what's there. Landed examples: *"Name, description, and visibility."* · *"Cover art and card layout."* · *"Delete or reset this deck."*

**Above an input, tell the reader what to put there** rather than asking them a question — *"If you've got an idea worth building, or found something that's broken, tell us here."* beats *"What would make TaroFlash better?"*. Length isn't the constraint; plainness is.

Copy itself is never yours to choose — see the sign-off rule in CLAUDE.md.
