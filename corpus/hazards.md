...
| →[K:session-bonus-remainder-discarded]          | [[rewards]]            | `supabase/schemas/85_rewards/credit_occasion_reward.sql`                                                                 |
| →[K:session-base-credited-on-boundary-cross]    | [[rewards]]            | `supabase/schemas/85_rewards/get_session_earnings.sql`, `supabase/schemas/60_reviews/close_study_session.sql`            |
