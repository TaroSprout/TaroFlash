...
const { paragraph_density } = vi.hoisted(() => ({ paragraph_density: {} }))

vi.mock('@/views/reader/composables/reader-prefs', () => ({
  useReaderPrefs: () => ({ paragraph_density: paragraph_density.ref })
}))
