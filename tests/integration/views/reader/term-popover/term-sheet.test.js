...
describe('TermSheet', () => {
  test('renders the term card with the selection when open', () => {
    ...
    expect(wrapper.find('[data-testid="term-sheet"]').exists()).toBe(true)
  ...
  test('renders nothing when closed', () => {
    ...
    expect(wrapper.find('[data-testid="term-sheet"]').exists()).toBe(false)
  })
  ...
  test('a pointerdown on the backdrop emits close', async () => {
    ...
    await wrapper.find('[data-testid="term-sheet__backdrop"]').trigger('pointerdown')
