...
<template>
  ...
  >
    <p
      ...
      class="text-brown-500 dark:text-brown-500"
    >
    ...
    <ul v-else data-testid="billing-settings__invoices-list" class="flex flex-col gap-2">
      <li
        ...
        class="grid grid-cols-[auto_1fr_auto_auto] items-center gap-4 bg-brown-200 dark:bg-stone-500 rounded-3 p-3 text-brown-700 dark:text-brown-200"
      >
        <span class="text-sm text-brown-500 dark:text-brown-500 tabular-nums">
