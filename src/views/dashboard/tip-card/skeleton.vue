<template>
  <div class="mt-6 w-full relative hidden md:flex flex-col items-center">
    <div
      data-testid="dashboard-tip-card-skeleton"
      class="h-47.5 w-full rounded-4 relative flex flex-col items-center justify-center gap-3 bg-skeleton px-10 shimmer"
    >
      <div
    ...
    <div
      ...
      class="absolute -top-4 rotate-3 h-9 w-40 rounded-1 bg-skeleton bgx-diagonal-stripes bgx-size-15 bgx-opacity-40 bgx-color-(--color-skeleton-sheen)"
    ></div>
  </div>
</template>
