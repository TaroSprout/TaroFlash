...
<template>
  <div data-testid="image-layout-picker" class="flex w-full justify-center gap-1">
    <button
      ...
      class="group relative flex cursor-pointer flex-col items-center gap-2 rounded-8 p-2 transition-colors hover:bg-brown-500 dark:hover:bg-stone-500 hover:bgx-diagonal-stripes hover:bgx-opacity-10 data-[active=true]:bg-(--theme-primary) data-[active=true]:bgx-diagonal-stripes data-[active=true]:bgx-opacity-10"
