...
<template>
  <div
    ...
    class="community-callout relative isolate flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 px-8 py-10 sm:px-12"
  >
    ...
    <div
      ...
      class="relative flex flex-col gap-3 text-center sm:text-left"
    >
