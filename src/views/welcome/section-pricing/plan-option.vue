...
<template>
  <div
    ...
    data-station="panel"
    class="w-full h-full mlg:min-w-94 flex flex-col gap-5 rounded-9 p-12 bg-surface text-ink"
  >
    ...
    <ul data-testid="plan-option__list" class="flex flex-col gap-3 text-start">
      ...
      >
        <span
          ...
          :class="
            feature.ok !== false ? 'bg-ink text-surface' : 'border-2 border-dashed border-ink/50'
          "
        >
