...
<template>
  <div
    ...
    class="relative h-12 w-full select-none overflow-hidden rounded-4 bg-well touch-none outline-none"
  ...
  >
    ...
    >
      <span
        ...
        class="flex items-center self-stretch bg-well px-1"
      >
        {{ label }}
      </span>
      <span
        data-testid="ui-kit-slider__value"
        class="flex items-center self-stretch bg-well px-1 tabular-nums"
      >
        {{ value }}
      </span>
    </div>
