...
<template>
  <div class="w-full bg-brown-100 dark:bg-grey-900">
    <div class="w-full bg-blue-500 dark:bg-blue-650 wave-top-[30px] p-20">
      <div class="max-w-(--page-width) mx-auto flex flex-col gap-10">
