  ...
  <div data-testid="app-shell-container" class="flex flex-col items-center gap-0.5">
    <div class="relative">
      <button
        ...
        class="rounded-6 pointer-fine:rounded-6 size-16.5 cursor-pointer hover:scale-110 focus:scale-110 transition-transform duration-50 flex items-center justify-center text-(--color-on-accent) group outline-none bg-(--color-accent) tap:bgx-diagonal-stripes motion-rich:tap:bgx-slide p-0.5"
        @click="onClick"
      >
        <slot>
          <ui-image
