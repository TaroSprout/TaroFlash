...
| `tests/`                                 | [`test-authoring`](.claude/rules/test-authoring.md) — only when I ask for tests                                                                                                                                                                             |
